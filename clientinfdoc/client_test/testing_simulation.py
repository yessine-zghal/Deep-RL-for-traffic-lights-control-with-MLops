...
class Simulation:
    def __init__(self,  TrafficGen, sumo_cmd, max_steps, green_duration, yellow_duration, num_cells, num_states, num_actions, n_cars, stl):
    ...
    def _choose_action(self, state):
        ...
        """
        pred = np.array(requests.post('http://127.0.0.1:5000/predict_test', json={'state': state.tolist()}).json()['prediction'])
